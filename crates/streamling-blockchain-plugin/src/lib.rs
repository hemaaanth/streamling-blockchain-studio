...
use sink::SqliteSink;
use source::{EvmBlockSource, EvmEventSource, EvmTransactionSource};
...
register_plugin_source!("streamling_blockchain", "evm_blocks", EvmBlockSource);
register_plugin_source!(
    "streamling_blockchain",
    "evm_transactions",
